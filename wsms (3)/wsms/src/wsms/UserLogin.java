	...
	public UserLogin() {
		...
		submit.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					checkUser f=new checkUser(new File("E:\\eclipse\\wsms\\src\\wsms\\Users"),username.getText(),new String(password.getPassword()));
					if(f.allowOrNot()) {
						userInterface fg=new userInterface(username.getText());
						fg.setVisible(true);
						dispose();
					}
					else {
